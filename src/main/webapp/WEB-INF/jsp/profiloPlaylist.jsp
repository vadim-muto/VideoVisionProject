...
<head>
	...
	<script src="/js/profiloPlaylist.js"></script>
	<title>Profilo PlayList</title>
</head>
<body id="body">
		...
		<nav class="navbar navbar-expand-sm navbar-dark sticky-top " id="navLink">  
		    ...
		    <div class="navLinks"><a class="nav-link" href="#" id="playlist"><i class="fa fa-book" aria-hidden="true"></i> Playlist</a></div>
		...
		<div id="centrale" class="bg-light text-dark">
			<h4>Queste sono le playlist che hai salvato:</h4>
			<br>
				<div class="row">
				...
				<c:forEach var="playlist" items="${listaPlaylist}"> 
					<div class="row">
						...
						<button type="button" class="btn btn-Quasidanger" value="${playlist.key}" onclick="eliminaPlaylist()"><i class="fa fa-times" aria-hidden="true"></i></button>
					  ...
					  <div id="${str2}" class="collapse row tabella">
					      ...
					      <c:forEach var="video" items="${playlist.value}">
					      	  <div class="row tabella ${str2}">
							      ...
							      <div class="col-2">
								  	<button type="button" value="${video.getLink()} , ${playlist.key}" class="btn btn-danger" onclick="eliminaVideo()"><i class="fa fa-trash" aria-hidden="true"></i></button>
								  </div>
							  </div>
						  </c:forEach>
					  	</div>
