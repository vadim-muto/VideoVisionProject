...
<head>
	...
	<script src="/js/profiloCanale.js"></script>
	<title>Profilo Canale</title>
</head>
<body id="body">
		...
		<nav class="navbar navbar-expand-sm navbar-dark sticky-top " id="navLink">  
		    <div class="navLinks"><a class="nav-link" href="#"> <i class="fa fa-video-camera" aria-hidden="true"></i> Video</a></div>
		    <form method="POST" action="visualizzaPlaylistCanale">
		    	<button value="${canale.getUsername()}" name="usernameCanale" class="noButton" type="submit" id="playlist"><i class="fa fa-book" aria-hidden="true"></i> Playlist</button>
		    </form>
		</nav>
	 
		<div id="centrale" class="bg-light text-dark">
			<h4>Video caricati su questo canale:</h4>
			<br>
				<div class="row tabella">
				      ...
				      <div class="col-2"><i class="fa fa-pencil" aria-hidden="true"></i> Descrizione</div>
				</div>
				<c:forEach var="video" items="${tuttiVideo}">
					<div class="row tabella">
					      <div class="col-2">
