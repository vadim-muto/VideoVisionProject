...
<head>
	...
	<script src="/js/profiloVideo.js"></script>
	<title>Profilo Video</title>
</head>
<body id="body">
		...
		<nav class="navbar navbar-expand-sm navbar-dark sticky-top" id="navLink">  
		    <div class="navLinks"><a class="nav-link" href="#" id="video"> <i class="fa fa-video-camera" aria-hidden="true"></i> Video</a></div>
		...
		<div id="centrale" class="bg-light text-dark">
			<h4>Questi sono i video che hai caricato:</h4>
			<br>
				...
				<c:forEach var="video" items="${tuttiVideo}">
					<div class="row tabella">
						  ...
						  <div class="col-2">
						  	<button type="button" value="${video.getLink()}" class="btn btn-danger" onclick="eliminaVideo()"><i class="fa fa-times" aria-hidden="true"></i> Elimina</button>
						  </div>
					</div>
				</c:forEach>  					
		</div>
